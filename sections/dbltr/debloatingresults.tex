...
\begin{table}[]
    \caption{LLOC reduction of debloated clusters: Numbers are reported in terms of thousands of LLOC. For Baseline, and \dbltr{}, we report the percentage of LLOC reduction compared to the Original application.}
    \centering
    \scalebox{0.87}{
...
%Third bar is the Optimal-Cluster where \dbltr{} determines the number of clusters by maximizing the average Silhouette scores. 
